...
$image_uploaded=$image_size=$image_type=$image_not_uploaded=$Error_to_uploaded=$File_not_image=$Image_deleted=$Error_to_Delete_Image=null;
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color:lightgrey;">
    ...
    <?php echo $image_uploaded.$image_size.$image_type.$image_not_uploaded.$Error_to_uploaded.$File_not_image.$Image_deleted.$Error_to_Delete_Image;?>
    <br>
            ...
            <div class="modal-dialog modal-sm">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="actionsBtns">
                      <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                      <a href="" class="btn btn-primary"><i class="fas fa-trash" onclick="event.preventDefault();document.getElementById('delete-profile-form').submit();"></i> Trash</a>
                      <button class="btn btn-danger" data-dismiss="modal"><i class="fas fa-times"></i> Not now</button>
                      <form id="delete-profile-form">
                        <?php

                            $result=mysqli_query($con,"UPDATE users SET image='user.png' where u_id=".$_SESSION['u_id']."");
                            if ($result) {
                              $Image_deleted='<script type="text/javascript">toastr.success("Profile image deleted !")</script>';
                            }else{
                              $Error_to_Delete_Image='<script type="text/javascript">toastr.error("Error to delete profile !")</script>';
                            }
