    ...
    <br>
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <h3><i class="fa fa-edit"></i>&nbsp;Edit information of <b><?php echo $fnames." ".$lnames;?></b></h3></div>
                  ...
                  <form action="" method="POST">
                    <div class="row">
                      <div class="col-md-6">
                          ...
                          <label>Card id</label>
                          <input type="text" name="card_ids" value="<?php echo $card_id;?>" class="form-control" disabled>
                          <label>Firstname</label>
                          <input type="text" name="firstname" value="<?php echo $fnames;?>" class="form-control">
                          <label>Middlename</label>
                          <input type="text" name="middlename" value="<?php echo $midname;?>" class="form-control">
                          <label>Lastname</label>
                          <input type="text" name="lastname" value="<?php echo $lnames;?>" class="form-control">
                          <label>Gender</label>
                      ...
                      <div class="col-md-6">
                            ...
                            <input type="text" name="province" value="<?php echo $province;?>" class="form-control">
                            <label>District</label>
                            <input type="text" name="district" value="<?php echo $district;?>" class="form-control">
                            <label>Sector</label>
                            <input type="text" name="sector" value="<?php echo $sector;?>" class="form-control">
                            <label>Cellule</label>
                            <input type="text" name="cellule" value="<?php echo $cellule;?>" class="form-control">
                            <label>Village</label>
                            <input type="text" name="village" value="<?php echo $village;?>" class="form-control">
                    ...
                    <div class="row">
                      <div class="col-md-12 text-center">
                        <button class="btn btn-primary" type="submit" name="submit_info"><i class="fa fa-save"></i>&nbsp; Save change</button>
                      </div>
                    </div>
        ...
        <?php
          if (isset($_POST['submit_info'])) {
            $fname_info=mysqli_real_escape_string($con,$_POST['firstname']);
            $mname_info=mysqli_real_escape_string($con,$_POST['middlename']);
            $lname_info=mysqli_real_escape_string($con,$_POST['lastname']);
            $gender_info=mysqli_real_escape_string($con,$_POST['gender']);
            $phone_info=mysqli_real_escape_string($con,$_POST['phone']);
            $dob_info=mysqli_real_escape_string($con,$_POST['dob']);
            $prov_info=mysqli_real_escape_string($con,$_POST['province']);
            $distr_info=mysqli_real_escape_string($con,$_POST['district']);
            $sect_info=mysqli_real_escape_string($con,$_POST['sector']);
            ...
            if ($sql_info == true) {
              ?>
                <script>
                  window.location.assign('CheckCitizenInfo.php');
                </script>
              <?php
            }
          }
