  ...
  <div class="content-wrapper"  style="background-color:lightgrey;">
    ...
    <br>
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                  <div class="card-header text-center bg-info"><span style="font-size:25px;"><span class="badge badge-light float-right"><?php $users->Count_years();?></span> Data in archive !</span></div>
                  <div class="card-body text-center" style="overflow: auto">
                    <?php
                      ...
                      if ($number == 0) {
                        echo "<span style='font-size:25px;'><b>No data found in archive !</b></span>";
                      }else{
                        ?>                      
                        <?php

                        $users->Fetch_year_Data_in_Archive();
                      }
                    ?>
                  </div>
                </div>
