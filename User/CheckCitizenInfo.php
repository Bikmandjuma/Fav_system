...
<head>
  ...
  <title>Check citizen info</title>
  ...
  <div class="content-wrapper" style="background-color:lightgrey;">
    ...
    <br>
        <div class="row">
            ...
            <div class="card">
              <div class="card-header text-center bg-info"><span style="font-size:25px;">Display citizen info</span></div>
              <div class="card-body text-center" style="overflow: auto">
                <span style=" font-size:25px;"><i class="fa fa-address-card"></i>&nbsp;<b>Show card information</b></span>
              </div>
            </div>
...
<script>
      ...
      function showUser(str) {
        if (str == "") {
          ...
          xmlhttp.open("GET","CheckCitizenInfoReadTagData.php?id="+str,true);
          xmlhttp.send();
        }
      }
